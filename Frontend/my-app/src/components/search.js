...
const SearchComponent = ({ setJobData }) => {
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await fetch(`https://ec2-52-63-5-206.ap-southeast-2.compute.amazonaws.com/api/api/1.0/search104?query=${searchTerm}`);
